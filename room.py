...
class Roombooking:
    def __init__(self,root):
        ...
        self.root.geometry("1250x550+100+120")
    ...
    # title
        ...
        # fetching data
        btnFetchData=Button(labelframeleft,command=self.Fetch_contact, text="Fetch",font=("arial",8,"bold"),bg="black",fg="gold",width=8)
        ...
        combo_RoomType=ttk.Combobox(labelframeleft,textvariable=self.var_roomtype,width=27,font=("arial",12,"bold"),state="readonly")
        ...
        Table_Frame.place(x=435,y=250,width=860,height=290)
        ...
        details_table.place(x=0,y=50,width=860,height=410)
        ...
        self.room_table.heading("contact",text="Contacts")
    ...
    def update_data(self):
        if self.var_contact.get()=="":
            messagebox.showerror("Error","Enter mobile No",parent=self.root)
             ...
             self.fetch_data()
             conn.close()
             messagebox.showinfo("Update","Room Updated Successfully",parent=self.root)
